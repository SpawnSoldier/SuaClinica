    ...
    <div class="cont_principal">
        ...
        <div class="login">
            ...
            <form action="exames.php" method="post">
                <h1>Buscar Exame</h1>
                <select id="regiao" name="regiao" class="form-select form-select-lg mb-2 col-12" aria-label=".form-select-sm example">
                    ...
                    <option value="4">Canoas</option>
                    <option value="5">Anta Gorda</option>
                    <option value="6">Pelotas</option>
                </select>

                <select id="especialidade" name="especialidade" class="form-select form-select-lg mb-2 col-12" aria-label=".form-select-sm example">
                    <!-- <option selected>Escolha uma Especialidade</option> -->
                    <option value="1">Colonoscopia</option>
                    <option value="2">Proctologista</option>
                    <option value="3">Cardiologista</option>
                    <option value="4">Otorrinolaringologista</option>
                    <option value="5">Ortopedista</option>
                    <option value="6">Oftalmologista</option>
                </select>
                <!-- <input type="date"> -->
